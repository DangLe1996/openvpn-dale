...
function newClient() {
	...
	cp /etc/openvpn/client-template.txt "/home/baodang153/$CLIENT.ovpn"
	{
		echo "<ca>"
	...
	} >>"/home/baodang153/$CLIENT.ovpn"

	echo ""
	echo "The configuration file has been written to /home/baodang153/$CLIENT.ovpn."
